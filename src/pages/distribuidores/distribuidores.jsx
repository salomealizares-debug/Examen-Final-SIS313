...
const ArrowBulletIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" className="sj-arrow">
    ...
    <path d="M10 8l4 4-4 4" fill="none" stroke="#3b93d6" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const OFICINA_CENTRAL = {
  ...
  emails: [
    "javieralconc@hotmail.com",
    "javieralconc@gmail.com",
    "javieralcon@sic-jac.com",
  ],
};
    ...
    entries: [
      {
        ...
        direccion:
          "c/ periodista n° 137 entre c/ la paz y millares frente supermercado súper sur",
