...
import { Maximize2, Share2, Layers, MessageCircle, Mail, MapPin } from 'lucide-react'
import './PgDeCont.css'
    ...
    <div className="oc-page">
      ...
      <div className="oc-container">
        ...
        <div className="oc-map-card">
          <div className="oc-map-tag">
            <div>
              ...
              <div className="oc-map-tag-address">Loayza 233, La Paz, Bolivia</div>
            </div>
        ...
        <div className="oc-contact-info">
          <p>
            <span className="oc-label-strong">Telf. Ofic.:</span> +591 2 2204283 | +591 2 2201462
          </p>
          <p>
            <span className="oc-label-strong">Cel. Ofic.:</span> +591 68597788 | +591 68597788 |
            +591 73208627
          </p>
          ...
          <div className="oc-contact-row">
            ...
            <p>Calle Loayza #233, Casa/Of. Marcial de Aparicio #6 III piso, La Paz</p>
          </div>
        </div>

        <p className="oc-required-note">
          Rellene el campo obligatorio. Todos los campos con asterisco (*) son obligatorios.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="oc-captcha-wrap">
            ...
            <div className="oc-captcha-box">
              ERROR para el propietario del sitio web: la clave del sitio web no es válida.
            </div>
          </div>
