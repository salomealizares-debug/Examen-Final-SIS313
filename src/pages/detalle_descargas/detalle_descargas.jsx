...
const IconPdf = () => (
  <svg viewBox="0 0 24 24" className="icon icon-pdf" aria-hidden="true">
    ...
    <text x="7.5" y="16" className="icon-label">PDF</text>
  </svg>
);
  ...
  return (
    <div className="modulo-inventario">
      ...
      <p className="modulo-descripcion">
        El Sistema de Inventarios permite el control y seguimiento físico
        valorado de los items o productos de un almacén. Los items son
        organizados en los siguientes niveles: Categoria, Subcategoria y
        producto (items). Por tal efecto el Sistema de Inventarios, le
        permite manipular su información en forma ordenada y minimizandole
        tiempo para el manejo y control de sus inventarios.
      </p>
